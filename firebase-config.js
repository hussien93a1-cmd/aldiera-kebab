...
window.KABAB = (() => {
  ...
  const settingsSeed = {
    ...
    whatsappStatusEnabled: true,
    whatsappAcceptedMessage: "تم قبول طلبك من كباب الديرة وجاري التحضير الآن.",
    whatsappReadyMessage: "طلبك جاهز للاستلام / أو جاهز للتوصيل.",
    whatsappDriverMessage: "طلبك أصبح مع السائق وفي الطريق إليك.",
    whatsappCompletedMessage: "تم تسليم طلبك. شكرًا لاختياركم كباب الديرة.",
    whatsappCanceledMessage: "نعتذر، تم إلغاء الطلب. يمكنكم التواصل معنا للاستفسار.",
    menuCleared: false,
    seedCompleted: false
  };
